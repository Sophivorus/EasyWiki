...
EasyWiki is a single, simple, beautiful PHP class, so [checking the source code](https://github.com/Sophivorus/EasyWiki/blob/main/EasyWiki.php) is probably the easiest way to learn about every available method. Alternatively, you can also check the [autogenerated documentation](https://sophivorus.github.io/EasyWiki/classes/EasyWiki.html).
